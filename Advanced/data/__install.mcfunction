...
tellraw @a ["",{"text":"[INFO] ","color":"green","bold":true},{"text":"Use ","color":"gray"},{"text":"/trigger ajjgui.menu","color":"yellow","click_event":{"action":"run_command","value":"/trigger ajjgui.menu"},"hover_event":{"action":"show_text","value":"Open main menu"}},{"text":" to start!","color":"gray"}]
